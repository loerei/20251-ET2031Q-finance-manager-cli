// Finance Manager v1.1 - Personal Finance Management System
// 
...
//
// Build: g++ -std=c++17 finance_v1_1.cpp -o finance_v1_1
// Usage: ./finance_v1_1 (interactive mode) or with helper flags (--dump-loc, --list-locales, etc.)
//
// Dependencies:
